package edu.stm.shop.controller.admin;
...
import edu.stm.shop.model.CategoryDto;
import edu.stm.shop.model.ProductDto;
import edu.stm.shop.service.CategoryService;
...
public class ProductController {
	...
	public String add(Model model) {
		model.addAttribute("category", new ProductDto());
